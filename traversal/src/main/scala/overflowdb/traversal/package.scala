...
package object traversal {
  ...
  implicit def toEdgeTraversal[A <: OdbEdgeTp3](traversal: Traversal[A]): EdgeTraversal[A] =
  ...
  implicit def toEdgeTraversalViaAdditionalImplicit[A <: OdbEdgeTp3, Trav](traversable: Trav)(implicit toTraversal: Trav => Traversal[A]): EdgeTraversal[A] =
